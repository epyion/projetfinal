				...
				<thead>
					<tr>
                        ...
                        <th>action</th>
							...
							<a href="#deleteMenbre" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
					</tr>
				</thead>
                ...
                <tbody>
					<tr>
						...
						<td><a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href="#deleteMembre" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
                </tbody>
				<?php } ?>
		...
		<div class="modal-content">
			<form>
				<div class="modal-header">						
					<h4 class="modal-title">ajouter membre</h4>
				...
				<div class="modal-body">					
                    ...
                    <div class="form-group">
						<label>role</label>
						<input type="select" class="form-control" required>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form>
				...
				<div class="modal-body">					
					<p>Ete vous sur de vouloir supprimer se membre?</p>
					<p class="text-warning"><small>action abandonner.</small></p>
				</div>
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
